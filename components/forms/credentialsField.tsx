    ...
    <section className="m-2">
      ...
      {pathName === Routes.SIGN_UP ? (
        <Link href={Routes.SIGN_IN}>
          ...
          <Button className="cursor-pointer primary-gradient m-0 paragraph-medium w-1/5 rounded-2 p-0 font-google-sans !text-light900">
            Sign In
          </Button>
        </Link>
      ) : (
        <Link href={Routes.SIGN_UP}>
          Don&#39;t you have account yet ? Click here to{" "}
          <Button className="cursor-pointer primary-gradient m-0 paragraph-medium w-1/5 rounded-2 p-0 font-google-sans !text-light900">
            Sign Up
          </Button>
        </Link>
